...
feature 'User registers', {vcr: true, js: true } do
  ...
  scenario "with valid user inf and valid card" do
  ...
  scenario "with invalid user info and valid card" do
    ...
    fill_in_valid_card
    click_button "Sign Up"
    expect(page).to have_content("There was a problem with your info. Please check the form below.")
  end
...
def fill_in_valid_user_info
  fill_in "Email Address", with: "bob@bob.com"
...
def fill_in_invalid_card
  fill_in "Credit Card Number", with: "654"
  fill_in "Security Code", with: "123"
  select "7 - July", from: "date_month"
  select "2015", from: "date_year"    
end
